...
int main()
{
    camera cam(point3(-2,2,1), point3(0,0,-1), vec3(0,1,0), constants::pi / 9, 1.0);
    ...
    auto texture_right = make_shared<solid_color>(color(1, 1, 1));
    ...
    auto material_right  = make_shared<metallic>(texture_right);
