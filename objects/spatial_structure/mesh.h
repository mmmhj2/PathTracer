...
struct triangle_vert
{
    ...
    const point3 * & operator [] (int index) noexcept
    {
        switch(index)
        {
        case 0:
...
struct triangle_uv
{
    ...
    const uv_pair * const & operator [] (int index) const noexcept
    {
        switch(index)
        {
        case 0:
    ...
    const uv_pair * & operator [] (int index) noexcept
    {
        switch(index)
        {
        case 0:
...
struct triangle_normal
{
    ...
    const vec3 * const & operator [] (int index) const noexcept
    {
        switch(index)
        {
        case 0:
    ...
    const vec3 * & operator [] (int index) noexcept
    {
        switch(index)
        {
        case 0:
